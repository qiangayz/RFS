# Generated by Django 2.0.5 on 2018-06-15 17:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(max_length=255, verbose_name='文章简介')),
                ('read_count', models.IntegerField(default=0, verbose_name='阅读量')),
                ('ctime', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('article_type_id', models.IntegerField(choices=[(1, 'python'), (2, 'linux'), (3, 'java'), (4, 'go'), (5, 'openstack')], default=None)),
            ],
        ),
        migrations.CreateModel(
            name='Article2Tag',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blog', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='category', to='repository.Blog', verbose_name='所属博客')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('acticle', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repository.Article', verbose_name='关联文章')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('blog', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tag', to='repository.Blog', verbose_name='所属博客')),
            ],
        ),
        migrations.CreateModel(
            name='UpDown',
            fields=[
                ...
                ('acticle', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repository.Article', verbose_name='文章')),
            ],
        ),
        migrations.CreateModel(
            name='UserFans',
        ...
        migrations.AddField(
            model_name='updown',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repository.UserInfo', verbose_name='操作人'),
        ),
        migrations.AddField(
            model_name='comment',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repository.UserInfo', verbose_name='评论人'),
        ),
        migrations.AddField(
            model_name='blog',
            name='user',
        ...
        migrations.AddField(
            model_name='article',
            name='category',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='repository.Category', verbose_name='文章类型（自定义的）'),
        ),
        migrations.AddField(
            model_name='article',
            name='tags',
